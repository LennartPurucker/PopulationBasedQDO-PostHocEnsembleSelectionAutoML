...
def _factory_qdo(rng_seed, metric, is_binary, labels, n_jobs, archive_type, behavior_space_choice, max_elites,
                 ...
                 batch_size):
    from assembled_ensembles.methods.qdo.qdo_es import QDOEnsembleSelection
    from numpy.random import RandomState
    ...
    if behavior_space_choice is None:
        ...
        from assembled_ensembles.methods.qdo.behavior_spaces import bs_configspace_similarity_and_loss_correlation
        bs = bs_configspace_similarity_and_loss_correlation()
    else:
